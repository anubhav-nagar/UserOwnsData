...
UserOwnsData.getEmbedUrl = async function (embedParam, embedType) {
    ...
    switch(embedType.toLowerCase()) {
        case "report":
            componentDetailsEndpoint = embedParam.workspaceId == "me" ? `${UserOwnsData.powerBiApi}/reports/${embedParam.reportId}` : `${UserOwnsData.powerBiApi}/groups/${embedParam.workspaceId}/reports/${embedParam.reportId}`;   
                      break;
        case "dashboard":
